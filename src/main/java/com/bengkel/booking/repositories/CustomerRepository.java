...
public class CustomerRepository {
	...
	public static List<Customer> getAllCustomer() {
		...
		Motorcycle motorCust1 = new Motorcycle("B231E", "Hitam", "Yamaha", "Otomatis", 2017, 155);
		...
		// Customer 2
		Vehicle motorCust2 = new Motorcycle("D6734ZD", "Merah", "Honda", "Otomatis", 2019, 125);
		...
		Motorcycle motorCust3 = new Motorcycle("Z231DHW", "Hitam", "Suzuki", "Manual", 2012, 135);
